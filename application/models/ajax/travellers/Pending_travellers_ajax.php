...
class Pending_travellers_ajax extends CI_Model
{
	...
	{
		return '<p><a type="button" href="' . base_url('admin_travellers/update_traveller/' . $traveller->id) . '" class="btn btn-default btn-sm btn-block action-btn clickable"> <i class="las la-pen" style="color: green"></i> &nbsp; Update Traveller </a></p>
