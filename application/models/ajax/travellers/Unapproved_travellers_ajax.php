...
class Unapproved_travellers_ajax extends CI_Model
{
	...
	public function actions($id)
	{
		...
		<p><a type="button" href="' . base_url('travellers/update_traveller/' . $id) . '" class="btn btn-default btn-sm btn-block action-btn clickable"> <i class="fa fa-pencil" style="color: green"></i> &nbsp; Update Traveller </a></p>
