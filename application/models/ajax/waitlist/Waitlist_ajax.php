...
class Waitlist_ajax extends CI_Model
{
    ...
    var $table = 'waitlist';
    var $column_order = array(null, 'id', 'name', 'phone', 'email'); //set column field database for datatable orderable
    var $column_search = array('id', 'name', 'phone', 'email'); //set column field database for datatable searchable 
    ...
    public function actions($id)
    {
        ...
        return '<p><a type="button" href="#" class="btn btn-default btn-sm btn-block action-btn clickable" data-toggle="modal" data-target="#delete' . $id . '"> <i class="fa fa-trash" style="color: red"></i> &nbsp; Delete </a></p>';
    }
    ...
    {
        $y = $this->common_model->get_waitlist_details_by_id($id);
        $modal_delete_confirm = modal_delete_confirm($id, $y->name, 'waitlist', 'waitlist/delete_waitlist');
