...
class Finances_ajax extends CI_Model
{
	...
	public function actions($id)
	{
		...
		return
			'<p><a type="button" href="' . base_url('finances/view_finance/' . $id) . '" class="btn btn-default btn-sm btn-block action-btn clickable"> <i class="fa fa-eye" style="color: green"></i> &nbsp; View Details</a></p>';
	}
