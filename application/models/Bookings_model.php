...
class Bookings_model extends MY_Model
{
	...
	public function add_booking_to_db($id_photo, $selfie)
	{
		...
		$data['sender_phone'] = $this->input->post('sender_country_code') . $data['sender_phone'];
	...
	public function approve_booking($id)
	{
		...
		$data['sender_name'] = $y->sender_name;
		$data['sender_phone'] = $y->sender_phone;
		$data['sender_email'] = $y->sender_email;
