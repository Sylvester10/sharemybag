...
class Bookings_model extends \MY_Model
{
	...
	public function add_booking_to_db($id_photo, $selfie)
	{
		...
		$data = array(
			...
			'agent_phone'     => normalize_phone_number($this->input->post('agent_country_code', TRUE), $this->input->post('agent_phone', TRUE)),
			...
			'receiver_phone'     => normalize_phone_number($this->input->post('receiver_country_code', TRUE), $this->input->post('receiver_phone', TRUE)),
