...
<head>
    ...
    <!--title-->
    <title> Recover Account - <?php echo business_name; ?></title>
                    ...
                    <div class="col-lg-10 col-12">
                        <div class="pricing-content-wrap bg-custom-light rounded-custom shadow-lg">
                                    ...
                                    <div class="tab-content" id="nav-tabContent">
                                        <div class="tab-pane fade show active" id="testimonial-tab-1" role="tabpanel">
                                            <div class="testimonial-tab-content mb-4">
                                                ...
                                                <div class="author-info mt-4 text-white">
                            ...
                            <div class="price-feature-col pricing-action-info p-5 right-radius bg-light-subtle order-0 order-lg-1">
                                ...
                                <p class="text-muted">Please provide the <b style="color: #f36b24;">email</b> associated with your account</p>

                                <div class="mt-4 register-form">

                                    <?php
                                    $form_attributes = array("id" => "recover_password_form");
                                    echo form_open('recover_password/password_recovery_ajax', $form_attributes); ?>
