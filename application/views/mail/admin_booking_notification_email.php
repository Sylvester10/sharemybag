...
<body>
    ...
    <div class="container">
        ...
        <div class="order-details" style="position: center;">
            ...
            <p>There is a new booking from <?= $agent_name ?>.</p>
            <br>
            <p>
                <a href="https://sharemybag.co.uk/admin" target="_blank" style="text-decoration: none; padding: 10px;background-color: #f36b24; color: white; border-radius: 5px;">Login your admin page.</a>
            </p>
