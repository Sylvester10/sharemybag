...
<body>
    ...
    <div class="container">
        ...
        <div class="order-details">
            ...
            <p>You requested for a password reset on your account. Please click the button below, enter your reset code and new password to reset your password.</p>

            <h2 style="margin:1rem 0; letter-spacing: 5px;"><?= $pass_reset_code ?></h2>
