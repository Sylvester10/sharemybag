...
<div class="modal fade admin-form-modal admin-form-modal--compact" id="addTravellerBagSpaceModal" role="dialog" aria-modal="true" aria-labelledby="addTravellerBagSpaceTitle">
    <div class="modal-dialog modal-md admin-form-modal__dialog">
        <div class="modal-content admin-form-modal__content">
            <div class="modal-header ">
                ...
                <h4 class="modal-title admin-form-modal__title" id="addTravellerBagSpaceTitle">Add Bag Space: <?php echo html_escape($traveller->fullname); ?></h4>
            </div>
            <?php echo form_open_multipart('admin_travellers/add_traveller_bag_space/' . $traveller->id, 'class="admin-form-modal__form"'); ?>
            <div class="modal-body admin-form-modal__body">
                <div class="form-group admin-form-modal__section">
                    <label class="form-control-label" for="addTravellerBagSpace">Select Bag Space</label>
                    <select class="form-control" name="selected_space" id="addTravellerBagSpace" required>
                        <?php echo $bag_options; ?>
                    </select>
                    <small class="admin-form-modal__note">Selected space will be added to the traveller’s original and available bag space.</small>
                </div>
            </div>
...
<div class="modal fade admin-form-modal admin-form-modal--compact" id="removeTravellerBagSpaceModal" role="dialog" aria-modal="true" aria-labelledby="removeTravellerBagSpaceTitle">
    <div class="modal-dialog modal-md admin-form-modal__dialog">
        <div class="modal-content admin-form-modal__content">
            <div class="modal-header ">
                <div class="pull-right">
                ...
                <h4 class="modal-title admin-form-modal__title" id="removeTravellerBagSpaceTitle">Remove Bag Space: <?php echo html_escape($traveller->fullname); ?></h4>
            </div>
            <?php echo form_open_multipart('admin_travellers/remove_traveller_bag_space/' . $traveller->id, 'class="admin-form-modal__form"'); ?>
            <div class="modal-body admin-form-modal__body">
                <div class="form-group admin-form-modal__section">
                    <label class="form-control-label" for="removeTravellerBagSpace">Select Bag Space</label>
                    <select class="form-control" name="selected_space" id="removeTravellerBagSpace" required>
                        <?php echo $bag_options; ?>
                    </select>
                    <small class="admin-form-modal__note">Selected space will be removed from the traveller’s original and available bag space.</small>
                </div>
            </div>
            <div class="modal-footer admin-form-modal__footer">
                <button type="submit" class="btn btn-md btn-primary">Update Bag Space</button>
