		...
		<tbody>
			...
			foreach ($booking_details as $y) { ?>
				...
				$receiver_details = '<i class="fa-solid fa-user"></i> ' . $y->receiver_name . ' <br />
					...
					// payment status
					$payment_status = ($y->payment_status === 'completed') ? '<span class="text-success">Paid</span>' : (($y->payment_status === 'canceled') ? '<span class="text-danger">Canceled</span>' : '<span class="text-warning">Pending</span>');
