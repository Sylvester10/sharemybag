<div class="new-item">
	...
	<a class="btn btn-default btn-sm button-adjust" href="<?php echo base_url('travellers/pending'); ?>"><i
			class="fa fa-users"></i> Pending Travellers</a>
</div>

<?php
echo form_open_multipart('travellers/update_traveller_ajax/' . $y->id, 'id="submit_button"'); ?>
...
<div class="row">
	...
	<div class="col-md-6 col-sm-12 col-xs-12">
		...
		<div class="form-group">
			...
			<br />
			<input type="text" name="name" value="<?php echo set_value('name', $y->name); ?>" class="form-control"
				required />
		...
		<div class="form-group">
			...
			<br />
			<input type="text" name="phone" value="<?php echo set_value('phone', $y->phone); ?>"
				class="form-control numbers-only" required readonly />
			<div class="form-error">
		...
		<div class="form-group">
			<label class="form-control-label">Alt Mobile No*</label>
			<br />
			<input type="text" name="alt_phone" value="<?php echo set_value('alt_phone', $y->alt_phone); ?>"
				class="form-control numbers-only" readonly />
			<div class="form-error">
		...
		<div class="form-group">
			...
			<br />
			<input type="email" name="email" class="form-control" value="<?php echo set_value('email', $y->email); ?>"
				required />
			<div class="form-error">
		...
		<div class="form-group">
			...
			<br />
			<input type="text" name="address" value="<?php echo set_value('address', $y->address); ?>"
		...
		<div class="form-group">
			...
			<select class="form-control" name="available_space" required>
				<option selected value="<?php echo $y->available_space; ?>"><?php echo $y->available_space; ?></option>
		...
		<div class="form-group">
			...
			<div class="input-group date calendar_date_datepicker" data-date-format="yyyy-mm-dd">
				<input type="text" class="form-control" name="travel_date"
					value="<?php echo set_value('travel_date', $y->travel_date); ?>" readonly required />
		...
		<div class="form-group">
			...
			<div class="input-group date calendar_date_datepicker" data-date-format="yyyy-mm-dd">
				<input type="text" class="form-control" name="arrival_date"
					value="<?php echo set_value('arrival_date', $y->arrival_date); ?>" readonly required />
				<div class="input-group-addon">
					<i class="fa fa-calendar"></i>
				</div>
				<div class="form-error">
		...
		<div class="form-group">
			...
			<select class="form-control" name="location" id="current_location" required>
				<option selected value="<?php echo $y->location; ?>"><?php echo $y->location; ?></option>

				<?php
				$countries = countries();
				foreach ($countries as $country) { ?>
					<option value="<?php echo $country; ?>" <?php echo set_select('location', $country); ?>><?php echo $country; ?></option>
				<?php } ?>
			</select>
			<div class="form-error">
		...
		<div class="form-group">
			...
			<select class="form-control" name="destination" required>
				<option selected value="<?php echo $y->destination; ?>"><?php echo $y->destination; ?></option>
				<?php
				$countries = countries();
				foreach ($countries as $country) { ?>
					<option value="<?php echo $country; ?>" <?php echo set_select('destination', $country); ?>><?php echo $country; ?></option>
				<?php } ?>
			</select>
			<div class="form-error">
	...
	<div class="col-md-6 col-sm-12 col-xs-12">
		...
		<div class="form-group" id="dropaddress1" style="display: none;">
			<label class="form-control-label">Drop Off Address (Same a Current Address) <input type="checkbox"
					id="populateDropAddress" /> </label>
			<br />
			<input type="text" name="drop_address1" value="<?php echo set_value('drop_address1', $y->drop_address1); ?>"
				class="form-control" />
			<div class="form-error">
		...
		<div class="form-group" id="dropdate1" style="display: none;">
			...
			<div class="input-group date calendar_date_datepicker" data-date-format="yyyy-mm-dd">
				<input type="text" class="form-control" name="drop_date1"
					value="<?php echo set_value('drop_date1', $y->drop_date1); ?>" readonly />
				<div class="input-group-addon">
					<i class="fa fa-calendar"></i>
				</div>
				<div class="form-error">
		...
		<div class="form-group" id="dropaddress2" style="display: none;">
			...
			<br />
			<input type="text" name="drop_address2" value="<?php echo set_value('drop_address2', $y->drop_address2); ?>"
				class="form-control" />
			<div class="form-error">
		...
		<div class="form-group" id="dropdate2" style="display: none;">
			...
			<div class="input-group date calendar_date_datepicker" data-date-format="yyyy-mm-dd">
				<input type="text" class="form-control" name="drop_date2"
					value="<?php echo set_value('drop_date2', $y->drop_date2); ?>" readonly />
				<div class="input-group-addon">
					<i class="fa fa-calendar"></i>
				</div>
				<div class="form-error">
		...
		<div class="form-group">
			...
			<select multiple class="form-control selectpicker" name="unwanted_items[]" required>
				<option selected value="<?php echo $y->unwanted_items; ?>"><?php echo $y->unwanted_items; ?></option>
