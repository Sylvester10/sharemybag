					...
					<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
						<div class="menu_section">
							<ul class="nav side-menu">
								...
								<li><a href="<?php echo base_url(); ?>" target="_blank"><i class="fa fa-home"></i> Visit
										Site</a></li>
								...
								<li><a><i class="fa fa-exchange"></i> Exchange Rate <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="<?php echo base_url('exchange'); ?>">All Exchange Rates</a></li>
									</ul>
								</li>
								...
								<li><a><i class="fa fa-plane"></i> Travellers <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										...
										<li><a href="<?php echo base_url('travellers/pending'); ?>">Pending
												Travellers</a></li>
										<li><a href="<?php echo base_url('travellers/unapproved'); ?>">Unapproved
												Travellers</a></li>
									</ul>
								</li>
