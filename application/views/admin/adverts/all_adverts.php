...
<div class="collapse m-b-50" id="upload_photo">
	<div class="card card-body">
		...
		echo form_open('adverts/upload_advert_ajax', $form_attributes); ?>
		...
		<div class="text-center m-t-20">
			<a class="btn btn-primary" href="<?php echo base_url('adverts/update_adverts'); ?>"
...
if ($total_records > 0) { ?>
	...
	echo modal_bulk_actions_alt('adverts/bulk_actions_adverts', $options_array); ?>
					...
					<div class="image view view-first">
						...
						<div class="mask">
							...
							<div class="tools tools-bottom">
								...
								<a type="button" href="<?php echo base_url('adverts/delete_advert/' . $p->id); ?>"
						...
						<div>
							...
							<?php if ($p->published == 'true') { ?>
								...
								<a class="btn btn-warning btn-xs" type="button"
									href="<?php echo base_url('adverts/unpublish_advert/' . $p->id); ?>"
									title="Unpublish advert">Unpublish</a>

							<?php } else { ?>

								<a class="btn btn-success btn-xs" type="button"
									href="<?php echo base_url('adverts/publish_advert/' . $p->id); ?>"
									title="Publish advert">Publish</a>

							<?php } ?>

							<a class="btn btn-danger btn-xs" type="button"
								href="<?php echo base_url('adverts/delete_advert/' . $p->id); ?>"
