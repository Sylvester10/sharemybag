        ...
        <div class="col-lg-6">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- Select Country -->
                    <div class="">
                        <select name="nationality" id="select-country" required class="required form-select border border-primary">
                            <option value="">Select country of residence</option>
                            <?php
                            $countries = countries();
                            foreach ($countries as $country) { ?>
                                <option value="<?php echo $country; ?>" <?php echo set_select('nationality', $country); ?>>
                                    <?php echo $country; ?>
                                </option>
                            <?php } ?>
                        </select>
                    ...
                    <!-- Loader -->
                    <div class="d-none mb-0" id="search-spinner">
                        ...
                        <form action="<?= base_url('kyc/verify_ajax') ?>" class="form-wizard-ajax" method="POST" enctype="multipart/form-data" target="_blank" redirect="<?= base_url('dashboard') ?>">
                            ...
                            <fieldset>
                                ...
                                <div class="mb-3 image_container">
                                    <img src="<?php echo base_url(); ?>assets/general/id-card.png" alt="" id="idHolder">
                            ...
                            <fieldset>
                                ...
                                <!-- <h5 class="card-title">Upload Legal Documents</h5> -->
                            ...
                            <fieldset>
                                ...
                                <div class="mb-3 image_container">
                                    <img src="<?php echo base_url(); ?>assets/general/selfie.png" alt="" id="selfie_holder">
                    ...
                    <div class="unitedkingdom">
                        <form action="<?= base_url('kyc/verify_ajax') ?>" class="form-wizard-ajax" method="POST" enctype="multipart/form-data" target="_blank" redirect="<?= base_url('dashboard') ?>">
                            ...
                            <fieldset>
                                ...
                                <div class="mb-3 image_container">
                                    <img src="<?php echo base_url(); ?>assets/general/id-card.png" alt="" id="idHolder2">
                                    <span class="reset_img_input inside_button">Remove ID</span>
                                </div>
                            </fieldset>
                            ...
                            <fieldset>
                                ...
                                <div class="mb-3 image_container">
                                    <img src="<?php echo base_url(); ?>assets/general/selfie.png" alt="" id="selfie_holder2">
                                    <span class="reset_img_input inside_button">Remove Selfie</span>
                                </div>
