			...
			for (
				var t,
					...
					p = [
						function (e, n, r) {
							var i =
								(!a && (r || n !== l)) || ((t = n).nodeType ? c(e, n, r) : f(e, n, r));
							return (t = null), i;
						},
					];
				u < o;
				...
				while ((o = s[n++]) && !t.isPropagationStopped()) {
					...
					while ((a = o.handlers[r++]) && !t.isImmediatePropagationStopped())
						(t.rnamespace && !t.rnamespace.test(a.namespace)) ||
							...
							(t.data = a.data),
							void 0 !==
								(i = ((w.event.special[a.origType] || {}).handle || a.handler).apply(
									o.elem,
									u
								)) &&
								!1 === (t.result = i) &&
	...
	function pt(e, t, n) {
		...
		for (ft(c, l.opts.specialEasing); o < a; o++)
			if ((r = pt.prefilters[o].call(l, e, c, l.opts)))
				return (
					g(r.stop) && (w._queueHooks(l.elem, l.opts.queue).stop = r.stop.bind(r)), r
				);
		return (
			w.map(c, lt, l),
					...
					return (
						...
						this.each(function (n) {
							...
							1 === this.nodeType &&
								...
								((t =
									w.valHooks[this.type] || w.valHooks[this.nodeName.toLowerCase()]) &&
									"set" in t &&
