...
(function (a, b) {
	...
	function d(b) {
		return !a(b)
			...
			.filter(function () {
				return (
					a.curCSS(this, "visibility") === "hidden" || a.expr.filters.hidden(this)
				);
			}).length;
	}
	a.ui = a.ui || {};
				...
				prepareOffsets: function (b, c) {
					...
					g: for (var h = 0; h < d.length; h++) {
						if (
							...
							(b && !d[h].accept.call(d[h].element[0], b.currentItem || b.element))
						)
							continue;
						...
						a.each(a.ui.ddmanager.droppables[b.options.scope] || [], function () {
							...
							!this.options.disabled &&
								...
								!this.options.disabled &&
									...
									((this.isout = 1), (this.isover = 0), this._deactivate.call(this, c));
						}),
						d
					);
				},
		...
		a.widget("ui.resizable", a.ui.mouse, {
						...
						a(this.element)
							...
							.hover(
								...
								function () {
									if (c.disabled) return;
									b.resizing ||
										(a(this).addClass("ui-resizable-autohide"), b._handles.hide());
								}
							)),
					this._mouseInit();
			},
				...
				resize: function (b, c) {
					...
					l[0] != document && /static/.test(l.css("position")) && (k = g),
						i.left < (d._helper ? g.left : 0) &&
							((d.size.width =
								d.size.width +
								(d._helper ? d.position.left - g.left : d.position.left - k.left)),
							j && (d.size.height = d.size.width / d.aspectRatio),
							(d.position.left = e.helper ? g.left : 0)),
						i.top < (d._helper ? g.top : 0) &&
							((d.size.height =
								d.size.height + (d._helper ? d.position.top - g.top : d.position.top)),
			...
			a.ui.plugin.add("resizable", "grid", {
				resize: function (b, c) {
					...
					var k =
							Math.round((f.width - g.width) / (e.grid[0] || 1)) * (e.grid[0] || 1),
						l =
							Math.round((f.height - g.height) / (e.grid[1] || 1)) * (e.grid[1] || 1);
					/^(se|s|e)$/.test(i)
				...
				(this.selectees = a(d.filter, this.element[0])),
					...
					a(b.target)
						...
						.each(function () {
							...
							if (d) {
								var e =
									(!b.metaKey && !b.ctrlKey) || !d.$element.hasClass("ui-selected");
								return (
									d.$element
			...
			_mouseDrag: function (b) {
				...
				if (this.options.scroll) {
					...
					this.scrollParent[0] != document && this.scrollParent[0].tagName != "HTML"
						? (this.overflowOffset.top + this.scrollParent[0].offsetHeight - b.pageY <
						  c.scrollSensitivity
								...
								: b.pageY - this.overflowOffset.top < c.scrollSensitivity &&
								  (this.scrollParent[0].scrollTop = d =
										this.scrollParent[0].scrollTop - c.scrollSpeed),
						  this.overflowOffset.left + this.scrollParent[0].offsetWidth - b.pageX <
						  c.scrollSensitivity
			...
			serialize: function (b) {
				...
				return (
					...
					a(c).each(function () {
						...
						c &&
							d.push(
								(b.key || c[1] + "[]") + "=" + (b.key && b.expression ? c[1] : c[2])
							);
					}),
					...
					for (var g = f.length - 1; g >= 0; g--) {
						...
						for (var i = h.length - 1; i >= 0; i--) {
							...
							j &&
								...
								(e.push([
									a.isFunction(j.options.items)
										? j.options.items.call(j.element[0], b, { item: this.currentItem })
										: a(j.options.items, j.element),
									j,
								]),
				...
				for (var g = e.length - 1; g >= 0; g--) {
					...
					for (var i = 0, m = l.length; i < m; i++) {
						...
						n.data(this.widgetName + "-item", k),
							c.push({ item: n, instance: k, width: 0, height: 0, left: 0, top: 0 });
					}
				}
			},
				...
				a.each(
					...
					function (b, e) {
						a.fx.step[e] = function (a) {
							a.colorInit ||
								((a.start = d(a.elem, e)), (a.end = c(a.end)), (a.colorInit = !0)),
								(a.elem.style[e] =
									"rgb(" +
									Math.max(
										Math.min(
						...
						e.clone()
							...
							.css({
								...
								left:
									f.left +
									j * (g / d) +
									(b.options.mode == "show" ? (j - Math.floor(d / 2)) * (g / d) : 0),
								top:
									f.top +
									i * (h / c) +
									(b.options.mode == "show" ? (i - Math.floor(c / 2)) * (h / c) : 0),
							...
							.animate(
								{
									left:
										f.left +
										j * (g / d) +
										(b.options.mode == "show" ? 0 : (j - Math.floor(d / 2)) * (g / d)),
									top:
										f.top +
										i * (h / c) +
										(b.options.mode == "show" ? 0 : (i - Math.floor(c / 2)) * (h / c)),
		...
		a.effects.slide = function (b) {
			return this.queue(function () {
				...
				var g = f == "up" || f == "down" ? "top" : "left",
					h = f == "up" || f == "left" ? "pos" : "neg",
					i =
						b.options.distance || (g == "top" ? c.outerHeight(!0) : c.outerWidth(!0));
							...
							b.toHide
								...
								.animate(g, {
									step: function (a, c) {
										c.prop == "height" &&
											(e =
												c.end - c.start === 0 ? 0 : (c.now - c.start) / (c.end - c.start)),
				...
				return b.length && b[0].label && b[0].value
					...
					: a.map(b, function (b) {
							return typeof b == "string"
								? { label: b, value: b }
								: a.extend({ label: b.label || b.value, value: b.value || b.label }, b);
					  });
			},
			_suggest: function (b) {
					...
					this.type === "checkbox"
						...
						: (this.buttonElement
								...
								.bind("keydown.button", function (b) {
									if (h.disabled) return !1;
									(b.keyCode == a.ui.keyCode.SPACE || b.keyCode == a.ui.keyCode.ENTER) &&
										a(this).addClass("ui-state-active");
								})
			...
			_resetButton: function () {
				...
				d.primary || d.secondary
					? (this.options.text &&
					  ...
					  d.primary &&
							b.prepend(
								"<span class='ui-button-icon-primary ui-icon " + d.primary + "'></span>"
							),
					  d.secondary &&
							b.append(
	...
	(function ($, undefined) {
		...
		$.extend(Datepicker.prototype, {
			...
			_setDateDatepicker: function (a, b) {
				...
				c &&
					(this._setDate(c, b), this._updateDatepicker(c), this._updateAlternate(c));
			},
			_getDateDatepicker: function (a, b) {
				var c = this._getInst(a);
				return (
					c && !c.inline && this._setDateFromField(c, b), c ? this._getDate(c) : null
				);
			},
			...
			_updateDatepicker: function (a) {
				...
				a.dpDiv
					...
					.width(""),
					f > 1 &&
						a.dpDiv.addClass("ui-datepicker-multi-" + f).css("width", g * f + "em"),
			...
			_checkOffset: function (a, b, c) {
				var d = a.dpDiv.outerWidth(),
					...
					h =
						document.documentElement.clientWidth + (c ? 0 : $(document).scrollLeft()),
					i =
						document.documentElement.clientHeight + (c ? 0 : $(document).scrollTop());
				return (
				...
				a.dpDiv.find("[data-handler]").map(function () {
					var a = {
						...
						selectMonth: function () {
							return (
								window["DP_jQuery_" + dpuuid].datepicker._selectMonthYear(c, this, "M"),
								!1
							);
						},
						selectYear: function () {
							return (
								window["DP_jQuery_" + dpuuid].datepicker._selectMonthYear(c, this, "Y"),
								!1
							);
						},
					};
						...
						for (var Z = 0; Z < X; Z++) {
							...
							for (var S = 0; S < 7; S++) {
								...
								(_ +=
									...
									((Y.getTime() == O.getTime() && n == a.selectedMonth && a._keyEvent) ||
									...
									(bb && !G
										...
										: " " +
										  ba[1] +
										  (Y.getTime() == k.getTime() ? " " + this._currentClass : "") +
			...
			_adjustInstDate: function (a, b, c) {
				var d = a.drawYear + (c == "Y" ? b : 0),
					...
					f =
						Math.min(a.selectedDay, this._getDaysInMonth(d, e)) + (c == "D" ? b : 0),
		...
		a.widget("ui.dialog", {
				...
				return (
					...
					a(
						b.element
							.find(":tabbable")
							.get()
							.concat(d.find(".ui-dialog-buttonpane :tabbable").get().concat(d.get()))
					)
						.eq(0)
						.focus(),
					(b._isOpen = !0),
			...
			a.extend(a.ui.dialog.overlay, {
				...
				create: function (b) {
					...
					var c = (
						this.oldInstances.pop() || a("<div></div>").addClass("ui-widget-overlay")
					)
						.appendTo(document.body)
		...
		(a.fn.position = function (b) {
					...
					left: function (b, c) {
						var d = a(window),
							e =
								...
								d.scrollLeft();
						b.left =
							e > 0 ? b.left - e : Math.max(b.left - c.collisionPosition.left, b.left);
					},
					top: function (b, c) {
						var d = a(window),
							e =
								...
								d.scrollTop();
						b.top =
							e > 0 ? b.top - e : Math.max(b.top - c.collisionPosition.top, b.top);
					},
				},
				flip: {
					left: function (b, c) {
			...
			(function () {
				...
				(d = document.createElement(b ? "div" : "body")),
					...
					b &&
						a.extend(g, { position: "absolute", left: "-1000px", top: "-1000px" });
		...
		a.widget("ui.slider", a.ui.mouse, {
			...
			_slide: function (a, b, c) {
				...
				this.options.values && this.options.values.length
					...
					: c !== this.value() &&
					  ((f = this._trigger("slide", a, { handle: this.handles[b], value: c })),
					  f !== !1 && this.value(c));
			},
			_stop: function (a, b) {
				var c = { handle: this.handles[b], value: this.value() };
			...
			_trimAlignValue: function (a) {
				...
				var b = this.options.step > 0 ? this.options.step : 1,
					...
					d = a - c;
				return (
					Math.abs(c) * 2 >= b && (d += c > 0 ? b : -b), parseFloat(d.toFixed(5))
				);
			},
			_valueMin: function () {
			...
			_refreshValue: function () {
				...
				this.options.values && this.options.values.length
					? this.handles.each(function (b, i) {
							(f =
								((d.values(b) - d._valueMin()) / (d._valueMax() - d._valueMin())) *
								100),
								...
								d.element.queue("tabs", function () {
									d._trigger(
										...
										d._ui(
											...
											d.element.find(d._sanitizeSelector(d.anchors[e.selected].hash))[0]
										)
									);
								}),
...
(function ($, undefined) {
	...
	$.widget("kf." + wizard, {
			...
			(function next() {
				self._transition(stepIndex, function (step, branch) {
					if ((stepIndex = self.stepIndex(step, branch)) === -1) {
						...
						throw new Error(
							'[_fastForward]: Recursion detected on step "' + step + '"'
						);
					} else {
		...
		_move: function (step, branch, relative, history, callback) {
			...
			function move(stepIndex, stepsTaken) {
				callback.call(
					self,
					stepIndex,
					$.isArray(history) ? history : history !== false ? stepsTaken : undefined
				);
			}
		...
		_update: function (event, state) {
			...
			if (
				(state.isLastStepInBranch && !state.step.attr(o.stateAttribute)) ||
