...
assert_contains_text($search_js, "traveller.destination === 'United Kingdom' ||", 'UK and Canada verification logic should be preserved.');
assert_contains_text($search_js, "traveller.destination === 'Canada'", 'Canada verification logic should be preserved.');
...
assert_contains_text($custom_css, 'max-width: 450px;', 'Search box should be narrower than the first implementation.');
...
assert_contains_text($custom_css, 'display: flex;', 'Mobile traveller cards should use a simple vertical card layout.');
assert_contains_text($custom_css, 'flex-direction: column;', 'Mobile traveller cards should stack content vertically.');
assert_contains_text($custom_css, '.traveller-card-visual {' . PHP_EOL . '        display: none;', 'Mobile traveller cards should hide the decorative visual block.');
